...
def d6service(name, keys, inbox, datapath, args):
    ...
    return MonascaEventDriver(name, keys, inbox, datapath, args)


class MonascaEventDriver(datasource_driver.PushedDataSourceDriver):
    ...
    events_translator = {
        ...
        'objects-extract-fn': widen_event,
        'field-translators':
    ...
    def __init__(self, name='', keys='', inbox=None, datapath=None, args=None):
        super(MonascaEventDriver, self).__init__(name, keys, inbox, datapath, args)

    @staticmethod
    def get_datasource_info():
        result = {}
        result['id'] = 'monasca_event'
        result['description'] = ('Datasource driver that interfaces with '
                                 'Monasca webhook events.')
        result['config'] = {}
        return result
